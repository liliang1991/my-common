...
public class MyHyperLogLog {
     ...
     * @param rsd  相对标准偏差
     */
    public MyHyperLogLog(double rsd) {
        this(log2m(rsd));
    }
     ...
     * @param log2m
     */
    public MyHyperLogLog(int log2m) {
     ...
     * @param registerSet
     */
    public MyHyperLogLog(int log2m, RegisterSet registerSet) {
    ...
    public static void main(String[] args) {
        MyHyperLogLog hyperLogLog = new MyHyperLogLog(0.1325);//64个桶
        //集合中只有下面这些元素
